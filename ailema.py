...
# Setup of intents. Intents = permissions the bot has 
...
async def on_ready():
    await bot.tree.sync()
    print("Ailema is online!") #bot.user uses the full bot's name.
...
@bot.tree.command(name="stop", description="Stop the song and clear the queue")
